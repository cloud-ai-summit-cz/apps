...
4. **Core GitHub secrets** – Add `AZURE_CLIENT_ID`, `AZURE_OBJECT_ID`, `AZURE_TENANT_ID`, `AZURE_SUBSCRIPTION_ID`, and `LETS_ENCRYPT_EMAIL` under *Settings → Secrets and variables → Actions*.
